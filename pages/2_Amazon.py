...
kpi_row([
    ...
    kpi_card("📦", "Units Sold",      f"{int(qty_tot):,}"),
    kpi_card("💰", "Total Revenue",   f"₹{revenue/1e7:.2f}Cr"),
    kpi_card("📊", "Avg Order Value", f"₹{avg_rev:.0f}"),
])
...
with c1:
    ...
    fig.update_layout(**PLOTLY_LAYOUT, height=300,
                      ...
                      title_text="Monthly Revenue", title_font=dict(color="#94A3B8", size=12),
                      showlegend=False)
...
with c4:
    ...
    fig4 = go.Figure(go.Bar(
        ...
        marker=dict(color=state_rev["Revenue"],
                    colorscale=[[0,"#1E3A5F"],[0.5,"#38BDF8"],[1,"#F97316"]],
                    line=dict(color="rgba(0,0,0,0)")),
...
with c5:
    ...
    fig5 = px.pie(ful_data, names="Fulfilment", values="Count",
                  color_discrete_sequence=["#F97316","#38BDF8","#A78BFA"],
                  hole=0.55)
